...
const PrivacyPolicy = () => {
  return (
    <Box padding={'40px'}>
      ...
      <Text color={'grey'}>Last updated: April 17, 2024</Text>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to News Media House, 106, SNS SYNERGY, Surat
            - Dumas Rd, near CENTRAL MALL, Surat, Gujarat 395007.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Surties, accessible from{" "}
            <a
              href="https://surties.in"
      ...
      <ul>
        <li>
          <p>By email: info@addit.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="www.theaddit.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.theaddit.com/contact
            </a>
          </p>
        </li>
        <li>
          <p>By phone number: 9033195000</p>
        </li>
      </ul>
    </Box>
  );
